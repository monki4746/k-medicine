...
public class PaintView extends View {
    ...
    public void saveImage () {
        ...
        File subDirectory = new File(sdDirectory.toString() + "/Pictures/KMedicine");
        ...
        if (subDirectory.exists()) {
            ...
            File image = new File(subDirectory, "/km_signature_" + (count + 1) + ".png");
            ...
            try {
                ...
                Toast.makeText(getContext(), "완료되었습니다", Toast.LENGTH_LONG).show();
